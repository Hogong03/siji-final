...
function isCommandMessage(msg) {
  ...
  return /(?:帮我(?:记|查|建|写|定|制定|安排|规划|创建|修改|更新|删除|撤销)|记一下(?:账|消费|支出|收入|记录)|查一下(?:账|账单|消费|记录|计划|人)|建一个(?:计划|记录)|写一篇(?:记录|日记|周报|月报)|创建(?:计划|记录|账单|决策)|修改(?:计划|记录|账单)|更新(?:计划|记录|画像)|删除(?:计划|记录|账单)|撤销)/.test(msg)
}
