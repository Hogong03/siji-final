...
用户透露偏好/习惯/重要事件时调 smart_update_profile 更新画像。`
  },
  {
    id: 'relation',
    name: '人脉图谱',
...
用户介绍新人物时调 create_relation，提到互动时调 log_interaction，查人物信息时调 query_relation。`
  },
  {
    id: 'decision',
    name: '决策助手',
...
用户面临选择时调 create_decision 记录决策日志，用「机会成本-风险-时机」三维框架引导思考。可调 query_decision 查历史决策。`
  },
  {
    id: 'plan_phases',
    name: '阶段化计划',
...
大目标调 create_plan_phases（而非 create_plan），自动拆解为 2-6 阶段，每阶段含里程碑和子任务。`
  },
  {
    id: 'summary',
    name: '智能总结',
...
用户要总结/周报/月报时调 summarize_diaries，可结合 query_stat 分析消费趋势。`
  },
  {
    id: 'vision',
    name: '图片识别',
...
用户要求模拟对话时调 start_simulation 进入演练模式，结束后调 end_simulation 保存报告。`
  }
]
