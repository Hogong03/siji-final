...
export const DIARY_TOOLS = [
  ...
  {
    name: 'create_diary',
    description: '创建一条自由文本记录，首行自动作为标题。用户说"记一下/帮我记/写篇记录"时调用。正文必须放 content，禁止传 title 字段；record_type 三选一：日记/心情→diary，待办/要做→todo，其他（含想法、灵感、闪念）→note，禁止省略。标签不用传，系统会按内容自动打。',
    parameters: {
      type: 'object',
      properties: {
